-- Clean up the complex advanced matchmaking system and existing functions
...
DROP FUNCTION IF EXISTS run_match CASCADE;
DROP FUNCTION IF EXISTS enqueue_player CASCADE;
DROP FUNCTION IF EXISTS dequeue_player CASCADE;
