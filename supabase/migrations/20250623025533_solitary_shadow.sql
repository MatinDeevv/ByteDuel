/*
  # Fix Queue Management Functions

  This migration fixes the PostgreSQL syntax errors in queue management functions.
  
  1. Functions
    - cleanup_stale_queue_entries: Remove old queue entries
    - force_remove_from_queue: Force remove user from queue
