/*
  # Matchmaking Queue Management Functions

  1. Functions
    - `cleanup_stale_queue_entries()` - Remove queue entries older than 5 minutes
    - `force_remove_from_queue(uuid)` - Force remove a specific user from queue
    - `get_queue_stats()` - Get queue statistics and metrics

  2. Cleanup
    - Remove orphaned queue entries
    - Clean up existing stale entries
*/
