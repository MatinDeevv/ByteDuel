...
import { Mail, Lock, Eye, EyeOff, Github, ArrowLeft, Zap, User } from 'lucide-react';
...
const SignupPage: React.FC = () => {
  ...
  const { signUpWithEmail, signInWithGitHub, user, loading, error } = useAuth();
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Create your account and start competing in coding challenges
              </p>
            </motion.div>
            ...
            <AnimatedCard delay={0.2}>
              <div className="p-8">
                ...
                <form onSubmit={handleEmailSignUp} className="space-y-4">
                  ...
                  <AnimatedButton
                    type="submit"
                    disabled={isSubmitting || !email || !password || !displayName || password.length < 6}
